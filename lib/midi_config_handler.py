...
class MidiConfigHandler(ZynthianConfigHandler):
    ...
    def get(self, errors=None):
        ...
        current_note_cuia_text = self.get_midi_env(
        ...
        if current_note_cuia_text:
            ...
            for note, cuia in current_note_cuia.items():
                current_note_cuia_text += "{}: {}\n".format(note, cuia)
        mmncuia_config = {'CUIA_LIST': cuia_list,
                          'CURRENT_NOTE_CUIA': current_note_cuia}
        ...
        config = {
            ...
            'display_midi_ports_panel': {
                'type': 'button',
                'title': 'MIDI Devices',
                        'button_type': 'button',
                        'class': 'btn-theme btn-block',
                        'icon': 'fa fa-eye',
                        'html_file': 'midi_ports.html',
                        'html_file_config': ports_config,
                        'advanced': False
            },
